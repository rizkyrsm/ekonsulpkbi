<x-layouts.app :title="__('Tambah Cabang')">
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 h-full w-full">
        ...
        <div class="col-span-1 flex flex-col gap-6 rounded-xl border border-neutral-200 dark:border-neutral-700 p-6 bg-white dark:bg-neutral-900 shadow">
            ...
            <x-auth-header :title="__('Tambah User Cabang')" :description="__('Tambah user baru untuk cabang')" />
                            ...
                            <tr class="bg-white dark:bg-neutral-900 hover:bg-gray-50 dark:hover:bg-neutral-800 transition">
                                ...
                                <td class="px-4 py-2 text-gray-600 dark:text-gray-400">
                                    <div class="flex space-x-2">
                                        <!-- Tombol Edit -->
                                        <a href="{{ route('cabang.edit', $user->id) }}" class="text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300" title="Edit">
                                            <!-- Heroicon Pencil -->
                                        ...
                                        <!-- Tombol Hapus -->
                                        <form action="{{ route('cabang.destroy', $user->id) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus user ini?');">
                                            @csrf
                                            @method('DELETE')
